...
const S = {
  en: {
    ...
    label: {
      ...
      ourLogo: 'Our Logo', consultation: 'consultation available', clickToLearn: 'Learn more', menu: 'Menu', social: 'Social',
    },
  ...
  ar: {
    ...
    label: {
      ...
      ourLogo: 'شعارنا', consultation: 'الاستشارة متاحة', clickToLearn: 'اعرف المزيد', menu: 'القائمة', social: 'التواصل',
    },
