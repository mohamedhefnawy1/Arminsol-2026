...
const S = {
  en: {
    ...
    label: {
      ...
      ourLogo: 'Our Logo', consultation: 'consultation available', clickToLearn: 'Click to learn more', menu: 'Menu', social: 'Social',
    },
  ...
  ar: {
    ...
    label: {
      ...
      ourLogo: 'شعارنا', consultation: 'الاستشارة متاحة', clickToLearn: 'انقر لمعرفة المزيد', menu: 'القائمة', social: 'التواصل',
    },
